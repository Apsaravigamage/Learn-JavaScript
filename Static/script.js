...
function updateScore(card, activePlayer){
    if (card ==='A'){
    // If adding 11 keeps me balow 21,add 11. Otherwise add 1.
...
function computeWinner(){
    ...
    if (YOU['score'] <= 21){
        //condition: Higher scor than dealer or when dealer busts but you're 21 or under
